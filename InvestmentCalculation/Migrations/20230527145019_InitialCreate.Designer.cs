...
namespace InvestmentCalculation.Migrations
{
    ...
    [Migration("20230527145019_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InvestmentCalculation.Data.Entities.InvestmentCalculate", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text")
                    ...
                    b.Property<int>("JurisprudenceCompanyForm")
                        .HasColumnType("integer")
                        .HasColumnName("jurisprudence_company_form");
                    ...
                    b.ToTable("InvestmentCalculations");
                });
            ...
            modelBuilder.Entity("InvestmentCalculation.Data.Entities.MoscowDistrict", b =>
                {
                    ...
                    b.Property<double>("MeanPricePerSquareMeter")
            ...
            modelBuilder.Entity("InvestmentCalculation.Data.Entities.ProjectUser", b =>
                {
                    ...
                    b.Property<string>("UserBranchOfTheEconomyId")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("UserBranchOfTheEconomyId");
            ...
            modelBuilder.Entity("InvestmentCalculation.Model.MachineRequestInfo", b =>
                {
                    ...
                    b.Property<string>("InvestmentCalculateId")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("InvestmentCalculateId");
            ...
            modelBuilder.Entity("InvestmentCalculation.Data.Entities.ProjectUser", b =>
                {
                    b.HasOne("InvestmentCalculation.Data.Entities.EconomyBranch", "UserBranchOfTheEconomy")
                        .WithMany()
                        .HasForeignKey("UserBranchOfTheEconomyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("UserBranchOfTheEconomy");
                });

            modelBuilder.Entity("InvestmentCalculation.Model.MachineRequestInfo", b =>
                {
                    b.HasOne("InvestmentCalculation.Data.Entities.InvestmentCalculate", null)
                        .WithMany("MachineRequestInfos")
                        .HasForeignKey("InvestmentCalculateId");
